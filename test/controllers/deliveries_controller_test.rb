...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { description: @delivery.description, image_url: @delivery.image_url, item: @delivery.item, price: @delivery.price }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { description: @delivery.description, image_url: @delivery.image_url, item: @delivery.item, price: @delivery.price }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
